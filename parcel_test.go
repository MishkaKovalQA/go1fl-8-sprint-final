...
func openTrackerStore(t *testing.T) ParcelStore {
...
func TestGetByClient(t *testing.T) {
	...
	for i := 0; i < len(parcels); i++ {
		id, err := store.Add(parcels[i]) // добавьте посылку в БД, убедитесь в отсутствии ошибки и наличии идентификатора
		require.NoError(t, err)
		assert.NotEmpty(t, id)
